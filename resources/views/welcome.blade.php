...
<h1 class="text-center">Daftar nama karyawan</h1>
        ...
        @foreach ($karyawan as $b)
          <div class="card" style="width: 18rem;">
              ...
              <div class="card-body">
                ...
                <p class="card-text">Name: {{$b->namakaryawan}}</p>
                <p class="card-text">Age: {{$b->umurkaryawan}}</p>
                <p class="card-text">Adress: {{$b->alamatkaryawan}}</p>
